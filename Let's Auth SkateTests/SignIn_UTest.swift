...
class SignIn_UTest: XCTestCase {
    ...
    func test_email_is_badly_formated_password_empty() async {
        do {
            try await signIn.loginUserWith(email: "youssef", password: "")
            XCTAssert(user == nil)
        } catch {
    ...
    func test_email_is_badly_formated_password_not_empty() async {
        do {
            try await signIn.loginUserWith(email: "youssef", password: "123412341234")
            XCTAssert(user == nil)
        } catch {
            // verify that we got the correct error
            XCTAssert(error as! LoginErrors == LoginErrors.emailNotFormated)
    ...
    func test_email_correct_but_doesnt_exsist() async {
        do {
            try await signIn.loginUserWith(email: "youssef@gmail.com", password: "123412341234")
            XCTAssert(user == nil)
        } catch {
            // verify that we got the correct error
    ...
    func test_email_correct_exist_but_wrong_password() async {
        do {
            try await signIn.loginUserWith(email: "youssef.b.air2@gmail.com", password: "1111111")
            XCTAssert(user == nil)
        } catch {
            // verify that we got the correct error
    ...
    func test_login_to_disabled_account() async {
        do {
            try await signIn.loginUserWith(email: "youssef.b.air3@gmail.com", password: "12341234")
            XCTAssert(user == nil)
        } catch {
            // verify that we got the correct error
            print(error)
    ...
    func test_no_connection_while_login() async {
        do {
            try await signIn.loginUserWith(email: "youssef.b.air2@gmail.com", password: "12341234")
        } catch {
